...
for (items of pokemons) {
    ...
    // let newEgg = document.createElement("p");
    // let newSpawn = document.createElement("p");
    // let newAvg = document.createElement("p")
    // let newTime = document.createElement("p")
    // let newMulti = document.createElement("p");
    // let newWek = document.createElement("p");
    // let newPrev = document.createElement("p");
    // let newNext = document.createElement("p");
    
    newLi.style.listStyle = "none"
    newLi.style.border = "2px"
    newLi.style.borderRadius = "20px"
    newLi.style.margin = "50px"
    newLi.style.padding = "50px"
    // newLi.style.width = "300px"
    // newLi.style.height = "400px"

    
    
    newId.textContent = items.id;
    newNum.textContent = items.num;
    newName.textContent = items.name;
    newImg.src = items.img
    newType.textContent = items.type;
    newHeight.textContent = items.height;
    // newWeight.textContent = items.weight;
    // newCandy.textContent = items.candy;
    // newEgg.textContent = items.egg;
    // newSpawn.textContent = items.spawn_chance;
    // newAvg.textContent = items.avg_spawns;
    // newTime.textContent = items.spawn_time;
    // newMulti.textContent = items.multipliers;
    // newWek.textContent = items.weaknesses;
    // newPrev.textContent = items.prev_evolution;
    // newNext.textContent = items.next_evolution;
    ...
    // elList.appendChild(newWeight)
    // elList.appendChild(newCandy)
    // elList.appendChild(newEgg)
    // elList.appendChild(newSpawn)
    // elList.appendChild(newAvg)
    // elList.appendChild(newTime)
    // elList.appendChild(newMulti)
    // elList.appendChild(newWek)
    // elList.appendChild(newPrev)
    // elList.appendChild(newNext)
